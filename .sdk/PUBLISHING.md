...
|---|---|---|
| `ts/` | @voxgig-sdk/energy-radio-stations-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/energy-radio-stations-sdk \
      --repository voxgig-sdk/energy-radio-stations-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/energy-radio-stations-sdk` shows it, and
`npm trust revoke @voxgig-sdk/energy-radio-stations-sdk --id=<id>` removes it.
