...
// EnergyRadioStations SDK telemetry feature
...
class EnergyRadioStationsTelemetryFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _close(EnergyRadioStationsContext $ctx, bool $ok): void
    {
