...
// EnergyRadioStations SDK netsim feature
...
class EnergyRadioStationsNetsimFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _simulate(EnergyRadioStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EnergyRadioStationsContext $ctx, array $applied): void
    {
        $client = $this->client;
