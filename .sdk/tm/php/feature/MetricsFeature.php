...
// EnergyRadioStations SDK metrics feature
...
class EnergyRadioStationsMetricsFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _record(EnergyRadioStationsContext $ctx, bool $ok): void
    {
