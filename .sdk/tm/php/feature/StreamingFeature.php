...
// EnergyRadioStations SDK streaming feature
...
class EnergyRadioStationsStreamingFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _iterate(EnergyRadioStationsResult $result): \Generator
    {
    ...
    private function _streamable(EnergyRadioStationsContext $ctx): bool
    {
