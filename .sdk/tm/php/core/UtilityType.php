...
// EnergyRadioStations SDK utility type

class EnergyRadioStationsUtility
{
    ...
    public static function copy(EnergyRadioStationsUtility $src): EnergyRadioStationsUtility
    {
        $u = new EnergyRadioStationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
