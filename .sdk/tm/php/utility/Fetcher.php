...
// EnergyRadioStations SDK utility: fetcher

class EnergyRadioStationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EnergyRadioStationsSDK/1.0)';
    ...
    public static function call(EnergyRadioStationsContext $ctx, string $fullurl, array $fetchdef): array
    {
