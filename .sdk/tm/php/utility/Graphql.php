...
// EnergyRadioStations SDK utility: graphql
//
...
class EnergyRadioStationsGraphql
{
    ...
    // equivalent.
    public static function body(EnergyRadioStationsContext $ctx): mixed
    {
    ...
    public static function errors(EnergyRadioStationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
