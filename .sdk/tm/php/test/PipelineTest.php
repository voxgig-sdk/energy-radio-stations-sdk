...
// EnergyRadioStations SDK pipeline test
//
...
{
    private static function utility(): EnergyRadioStationsUtility
    {
        return new EnergyRadioStationsUtility();
    }
    ...
    private static function ctx(array $over = []): EnergyRadioStationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EnergyRadioStationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EnergyRadioStationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EnergyRadioStationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EnergyRadioStationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EnergyRadioStationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EnergyRadioStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EnergyRadioStationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EnergyRadioStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EnergyRadioStationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EnergyRadioStationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EnergyRadioStationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EnergyRadioStationsResponse([]),
            'result' => new EnergyRadioStationsResult([]),
        ]);
        [, $err] = EnergyRadioStationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new EnergyRadioStationsSpec([]),
            'response' => null,
            'result' => new EnergyRadioStationsResult([]),
        ]);
        [, $err] = EnergyRadioStationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EnergyRadioStationsSpec(['step' => 's']),
            'response' => new EnergyRadioStationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EnergyRadioStationsResult([]),
        ]);
        [, $err] = EnergyRadioStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EnergyRadioStationsSpec(['step' => 's']),
            'response' => new EnergyRadioStationsResponse(self::resp(200, ['v' => 1])),
            'result' => new EnergyRadioStationsResult([]),
        ]);
        [, $err] = EnergyRadioStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EnergyRadioStationsSpec(['step' => 's']),
            'response' => new EnergyRadioStationsResponse(self::resp(200, ['v' => 2])),
            'result' => new EnergyRadioStationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EnergyRadioStationsMakeResponse::call($ctx);
    ...
    {
        $preset = new EnergyRadioStationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EnergyRadioStationsSpec([]),
            'response' => new EnergyRadioStationsResponse([]),
            'result' => new EnergyRadioStationsResult([]),
        ...
        [$got, $err] = EnergyRadioStationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EnergyRadioStationsResult([])]);
        [, $err] = EnergyRadioStationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EnergyRadioStationsSpec([]), 'result' => null]);
        [, $err] = EnergyRadioStationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EnergyRadioStationsSpec(['step' => 's']),
            'result' => new EnergyRadioStationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EnergyRadioStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EnergyRadioStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EnergyRadioStationsSpec(['step' => 's']),
            'result' => new EnergyRadioStationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EnergyRadioStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EnergyRadioStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EnergyRadioStationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EnergyRadioStationsSpec([]),
            'result' => new EnergyRadioStationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EnergyRadioStationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EnergyRadioStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EnergyRadioStationsError('boom', 'boom');
        $utility->fetcher = function (EnergyRadioStationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EnergyRadioStationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EnergyRadioStationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EnergyRadioStationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EnergyRadioStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EnergyRadioStationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        EnergyRadioStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EnergyRadioStationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EnergyRadioStationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EnergyRadioStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EnergyRadioStationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EnergyRadioStationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EnergyRadioStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EnergyRadioStationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EnergyRadioStationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EnergyRadioStationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EnergyRadioStationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EnergyRadioStationsResult(['ok' => false])]);
        $this->expectException(EnergyRadioStationsError::class);
        EnergyRadioStationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EnergyRadioStationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EnergyRadioStationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        EnergyRadioStationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EnergyRadioStationsBaseFeature();
        $b = new EnergyRadioStationsBaseFeature();
        EnergyRadioStationsFeatureAdd::call($ctx, $a);
        EnergyRadioStationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EnergyRadioStationsBaseFeature
    {
        $f = new EnergyRadioStationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EnergyRadioStationsFeatureAdd::call($ctx, self::named_feature('a'));
        EnergyRadioStationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        EnergyRadioStationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        EnergyRadioStationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        EnergyRadioStationsFeatureAdd::call($ctx, $replace);
        ...
        EnergyRadioStationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EnergyRadioStationsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EnergyRadioStationsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EnergyRadioStationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        EnergyRadioStationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EnergyRadioStationsResponse(['headers' => null]),
            'result' => new EnergyRadioStationsResult([]),
        ]);
        EnergyRadioStationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        EnergyRadioStationsResultBody::call($ctx);
