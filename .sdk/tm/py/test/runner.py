...
class EnergyRadioStationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EnergyRadioStationsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EnergyRadioStationsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EnergyRadioStationsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
