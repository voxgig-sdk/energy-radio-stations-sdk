...
local function make_error_util(ctx, err)
  ...
  local msg = "EnergyRadioStationsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = EnergyRadioStationsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == EnergyRadioStationsError then
