...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ENERGYRADIOSTATIONS_TEST_LIVE ||
    'TRUE' === process.env.ENERGYRADIOSTATIONS_TEST_OVERRIDE
  ) {
  ...
  m.ENERGYRADIOSTATIONS_TEST_EXPLAIN = process.env.ENERGYRADIOSTATIONS_TEST_EXPLAIN || m.ENERGYRADIOSTATIONS_TEST_EXPLAIN
