...
(0, node_test_1.describe)('PlayoutDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EnergyRadioStationsSDK({
    ...
    (0, node_test_1.test)('direct-list-playout', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-playout', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["station01"]))
            return;
...
function liveScenariosActive() { return false && process.env.ENERGY_RADIO_STATIONS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EnergyRadioStationsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ENERGY_RADIO_STATIONS_TEST_PLAYOUT_ENTID'];
    ...
    const client = new __1.EnergyRadioStationsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PlayoutDirect.test.js.map