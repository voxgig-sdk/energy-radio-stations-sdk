...
function envOverride(m) {
    if ('TRUE' === process.env.ENERGY_RADIO_STATIONS_TEST_LIVE ||
        'TRUE' === process.env.ENERGY_RADIO_STATIONS_TEST_OVERRIDE) {
    ...
    m.ENERGY_RADIO_STATIONS_TEST_EXPLAIN = process.env.ENERGY_RADIO_STATIONS_TEST_EXPLAIN || m.ENERGY_RADIO_STATIONS_TEST_EXPLAIN;
    return m;
}
