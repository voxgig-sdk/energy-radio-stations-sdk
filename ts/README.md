# EnergyRadioStations TypeScript SDK



The TypeScript SDK for the EnergyRadioStations API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Playout()` — each with a small set of operations (`list`)
...
```ts
new EnergyRadioStationsSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| Method | Returns | Description |
| --- | --- | --- |
| `EnergyRadioStationsSDK.test(testopts?, sdkopts?)` | `EnergyRadioStationsSDK` | Create a test-mode client. |
...
| `client` | `client(): EnergyRadioStationsSDK` | Return the parent SDK client. |
...
├── src/
│   ├── EnergyRadioStationsSDK.ts        # Main SDK class
