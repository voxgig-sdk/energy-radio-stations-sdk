...
The TypeScript SDK for the EnergyRadioStations API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new EnergyRadioStationsSDK({ apikey: '...' })
