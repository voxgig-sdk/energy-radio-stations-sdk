...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/energy-radio-stations` | `npm install @voxgig-sdk/energy-radio-stations` |
| Python | `voxgig-sdk-energy-radio-stations` | `pip install voxgig-sdk-energy-radio-stations` |
| PHP | `voxgig-sdk/energy-radio-stations` | `composer require voxgig-sdk/energy-radio-stations` |
| Golang | `github.com/voxgig-sdk/energy-radio-stations-sdk/go` | `go get github.com/voxgig-sdk/energy-radio-stations-sdk/go` |
| Ruby | `voxgig-sdk-energy-radio-stations` | `gem install voxgig-sdk-energy-radio-stations` |
| Lua | `voxgig-sdk-energy-radio-stations` | `luarocks install voxgig-sdk-energy-radio-stations` |
