...
// EnergyRadioStations SDK utility: result_basic

class EnergyRadioStationsResultBasic
{
    public static function call(EnergyRadioStationsContext $ctx): ?EnergyRadioStationsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EnergyRadioStationsError) ? $result->err->msg : (string)$result->err;
