...
// EnergyRadioStations SDK ratelimit feature
...
class EnergyRadioStationsRatelimitFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _acquire(EnergyRadioStationsContext $ctx): void
    {
    ...
    private function _track(EnergyRadioStationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
