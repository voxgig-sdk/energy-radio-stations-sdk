...
// EnergyRadioStations SDK timeout feature
...
class EnergyRadioStationsTimeoutFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _with_timeout(EnergyRadioStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EnergyRadioStationsContext $_ctx, float $ms): void
    {
        $client = $this->client;
