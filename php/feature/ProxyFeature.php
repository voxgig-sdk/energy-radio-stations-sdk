...
// EnergyRadioStations SDK proxy feature
...
class EnergyRadioStationsProxyFeature extends EnergyRadioStationsBaseFeature
{
    ...
    public function init(EnergyRadioStationsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EnergyRadioStationsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
