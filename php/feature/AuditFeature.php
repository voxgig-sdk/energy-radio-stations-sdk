...
// EnergyRadioStations SDK audit feature
...
class EnergyRadioStationsAuditFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _emit(EnergyRadioStationsContext $ctx, string $outcome): void
    {
