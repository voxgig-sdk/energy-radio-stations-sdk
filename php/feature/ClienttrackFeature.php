...
// EnergyRadioStations SDK clienttrack feature
...
class EnergyRadioStationsClienttrackFeature extends EnergyRadioStationsBaseFeature
{
    ...
    public function PostConstruct(EnergyRadioStationsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EnergyRadioStations-SDK';
