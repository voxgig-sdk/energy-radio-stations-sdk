...
// EnergyRadioStations SDK paging feature
...
class EnergyRadioStationsPagingFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _is_list(EnergyRadioStationsContext $ctx): bool
    {
