...
// EnergyRadioStations SDK rbac feature
...
class EnergyRadioStationsRbacFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _required(EnergyRadioStationsContext $ctx): ?string
    {
    ...
    private function _reject(EnergyRadioStationsContext $ctx, string $required): void
    {
    ...
    private function _track(EnergyRadioStationsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
