...
// EnergyRadioStations SDK cache feature
...
class EnergyRadioStationsCacheFeature extends EnergyRadioStationsBaseFeature
{
    ...
    private function _through(EnergyRadioStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
