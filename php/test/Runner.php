...
class EnergyRadioStationsTestRunner
{
    ...
    {
        $live = self::getenv('ENERGYRADIOSTATIONS_TEST_LIVE');
        $override = self::getenv('ENERGYRADIOSTATIONS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ENERGYRADIOSTATIONS_TEST_EXPLAIN');
