...
class EnergyRadioStationsTestRunner
{
    ...
    {
        $live = self::getenv('ENERGY_RADIO_STATIONS_TEST_LIVE');
        $override = self::getenv('ENERGY_RADIO_STATIONS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ENERGY_RADIO_STATIONS_TEST_EXPLAIN');
...
class_alias('EnergyRadioStationsTestRunner', 'Runner');
class_alias('EnergyRadioStationsHelpers', 'Helpers');
