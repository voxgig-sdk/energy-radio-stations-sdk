...
// EnergyRadioStations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EnergyRadioStationsSDK::test)
...
{
    private const SDK_CLASS = 'EnergyRadioStationsSDK';
    ...
    private const SDK_BASE = 'energyradiostations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../energyradiostations_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
