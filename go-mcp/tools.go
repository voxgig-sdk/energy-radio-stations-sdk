...
type Args struct {
	Entity string         `json:"entity" jsonschema:"playout"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EnergyRadioStationsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "energy-radio-stations_list",
		Description: "List records from EnergyRadioStations. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "energy-radio-stations_load",
		Description: "Load a single record from EnergyRadioStations. " +
...
func runOp(client *sdk.EnergyRadioStationsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
