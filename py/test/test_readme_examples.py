# EnergyRadioStations SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from energyradiostations_sdk import EnergyRadioStationsSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"EnergyRadioStationsSDK": EnergyRadioStationsSDK, "os": os}
        try:
