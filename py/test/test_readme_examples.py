# EnergyRadioStations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EnergyRadioStationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EnergyRadioStationsSDK(...) and EnergyRadioStationsSDK.test(...) become
#      EnergyRadioStationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "energyradiostations_sdk"
_SDK_CLASS = "EnergyRadioStationsSDK"
