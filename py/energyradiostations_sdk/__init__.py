...
from energyradiostations_sdk.utility import register

# Load features
from energyradiostations_sdk.feature.base_feature import EnergyRadioStationsBaseFeature
from energyradiostations_sdk.features import _has_feature, _make_feature
...
class EnergyRadioStationsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EnergyRadioStationsUtility()
    ...
    def get_utility(self):
        return EnergyRadioStationsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EnergyRadioStationsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Playout(self, data=None) -> "PlayoutEntity":
        ...
        from energyradiostations_sdk.entity.playout_entity import PlayoutEntity
