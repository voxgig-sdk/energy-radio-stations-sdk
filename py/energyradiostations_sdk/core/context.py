...
from energyradiostations_sdk.core.helpers import get_ctx_prop, to_map
...
class EnergyRadioStationsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EnergyRadioStationsControl()
        ...
        if isinstance(sp, EnergyRadioStationsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EnergyRadioStationsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EnergyRadioStationsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EnergyRadioStationsOperation({})
        ...
        op = EnergyRadioStationsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return EnergyRadioStationsError(code, msg, self)
