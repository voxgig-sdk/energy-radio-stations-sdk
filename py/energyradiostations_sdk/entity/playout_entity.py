...
from energyradiostations_sdk.energyradiostations_types import (
    Playout,
    PlayoutListMatch,
)
...
class PlayoutEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Playout]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Playout().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
