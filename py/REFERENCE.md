# EnergyRadioStations Python SDK Reference

Complete API reference for the EnergyRadioStations Python SDK.
...
#### `EnergyRadioStationsSDK.test(testopts=None, sdkopts=None)`
...
| `coverArt` | `str` | No | URL to album cover image |
| `duration` | `int` | No | Song duration in seconds |
| `id` | `str` | No | Unique identifier for the playlist entry |
