...
require_relative 'EnergyRadioStations_types'
...
class EnergyRadioStationsSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = EnergyRadioStationsHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = EnergyRadioStationsHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, EnergyRadioStationsFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    EnergyRadioStationsUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = EnergyRadioStationsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = EnergyRadioStationsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = EnergyRadioStationsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => EnergyRadioStationsError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue EnergyRadioStationsError => err
    ...
    if fetched.is_a?(Hash)
      status = EnergyRadioStationsHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = EnergyRadioStationsError.new(
        "graphql_error", "EnergyRadioStationsSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = EnergyRadioStationsSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
