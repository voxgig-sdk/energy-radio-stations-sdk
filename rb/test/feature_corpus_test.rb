# EnergyRadioStations SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # EnergyRadioStationsSDK.new, not EnergyRadioStationsSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    EnergyRadioStationsSDK.new(opts)
  end
