...
#      offline in seeded test mode (EnergyRadioStationsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EnergyRadioStations_sdk.rb")
  SDK_CLASS = "EnergyRadioStationsSDK"
  ...
  SDK_BASE = "EnergyRadioStations_sdk"
