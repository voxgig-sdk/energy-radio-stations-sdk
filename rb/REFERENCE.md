# EnergyRadioStations Ruby SDK Reference

Complete API reference for the EnergyRadioStations Ruby SDK.
...
```ruby
require_relative 'energy-radio-stations_sdk'
...
#### `EnergyRadioStationsSDK.test(testopts = nil, sdkopts = nil)`
