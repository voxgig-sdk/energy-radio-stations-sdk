// Command EnergyRadioStations-cli is a CLI + REPL for the EnergyRadioStations SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ENERGY_RADIO_STATIONS_APIKEY (api key), ENERGY_RADIO_STATIONS_BASE (base url override)")
