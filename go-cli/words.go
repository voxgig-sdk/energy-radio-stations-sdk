...
func registerSDKWords(r *eng.Registry, client *sdk.EnergyRadioStationsSDK) {
...
func runOp(client *sdk.EnergyRadioStationsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
